...
export class ErrorCodeMappingPropertiesComponent implements AfterViewInit{
  ...
  ngAfterViewInit() {
    this.dataSource = new MatTableDataSource([
      {
        rcx_error_code: '1234',
        description: 'Error code for RCX error Failure on Run the Process',
        partner_error_code: '4444',
        actions: '',
      },
      {
        rcx_error_code: '2342',
        description: 'Error code for RCX error Failure on Run the Process',
        partner_error_code: '234343',
        actions: '',
      },
      {
        rcx_error_code: '234',
        description: 'Error code for RCX error Failure on Run the Process',
        partner_error_code: '34523',
        actions: '',
      },
      {
        rcx_error_code: '234',
        description: 'Error code for RCX error Failure on Run the Process',
        partner_error_code: '45432',
        actions: '',
      },
    ]);

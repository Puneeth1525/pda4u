...
constructor(private matIconRegistry: MatIconRegistry,
  ...
  private router: Router) {
    this.matIconRegistry.addSvgIcon(
      `check-circle-broken`,
      this.domSanitizer.bypassSecurityTrustResourceUrl("../assets/icons/check-circle-broken.svg")
    );
    this.matIconRegistry.addSvgIcon(
      `check-circle`,
    ...
    this.matIconRegistry.addSvgIcon(
      `trash-red`,
      this.domSanitizer.bypassSecurityTrustResourceUrl("../assets/icons/trash-red.svg")
    );
    this.matIconRegistry.addSvgIcon(
      `trash`,
    ...
    this.matIconRegistry.addSvgIcon(
      `expand-all`,
      this.domSanitizer.bypassSecurityTrustResourceUrl("../assets/icons/expand-all.svg")
    );
    this.matIconRegistry.addSvgIcon(
      `Vector`,
